<!--
  ...
  interactive content beyond the primary nav list. The DA|EN
  locale toggle lives in the sticky header (`<LocaleSwitcher>`),
  not in this panel, so it's always visible without opening.
-->
<script lang="ts">
